      ...
      <div className='  flex justify-center w-full'>
        ...
        <div className=" mt-28 md:relative shadow-lg shadow-slate-400 mb-10   border flex w-4/5  h-full">
            ...
            <div className="md:w-4/5 w-10/12 md:py-20 pt-12 static  bg-quinary h-full">
                ...
                <form action=""  className={`static text-tertiary md:ml-20 ml-10 ${visible ? 'animate-slide' : 'opacity-0'}`}>
                ...
                <div  className={`md:absolute md:right-0 md:top-28 font-bold text-sm pl-10 py-12 border
