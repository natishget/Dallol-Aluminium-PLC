...
const Contact = () => {
  return (
    <div className='contact w-full md:h-screen h-full  '>
      <div className='w-full h-full bg-secondary_t text-primary  md:flex justify-center items-center pt-28 md:pb-8  '>
