...
const Home = () => {
  ...
  return (
    <div className="w-full font-sans">
      <Helmet>
        <title>Dallol Aluminum-Home</title>
      ...
      <div className="bg-[#1f1f22] text-white w-full">
      ...
      <div className="grid lg:grid-cols-4 text-gray-600 bg-gray-100 md:p-14 p-8 lg:gap-x-6">
        <div className="lg:my-auto mb-12">
          ...
          <ScrollTrigger onEnter={onEnterViewport3} onExit={onExitViewport3}>
            <Link
              to="service"
              className={`hover:bg-black bg-primary text-gray-900 font-bold hover:text-primary font-bold hover:font-bold
           py-2 mt-4 px-4 shadow-lg rounded-xl transition duration-300 ease-in-out transform hover:scale-105
           ${visible3 ? "animate-slide2" : "opacity-0"}`}
            >
              {t("home.button1")}
            </Link>
          </ScrollTrigger>
      ...
      <div className="lg:pl-6 pt-10 lg:flex w-full justify-around  text-sans">
        <div className="lg:pl-5 md:px-10 lg:px-0 px-8 md:w-7/12">
          <p className="md:text-4xl text-3xl font-bold text-gray-700">
            {t("home.discover")}
          </p>
          <p className="mt-4 text-gray-600 mb-10">
            {t("home.discover-paragraph")}
          </p>
          <Link
            to="contact"
            className="hover:bg-black bg-primary text-gray-900 font-bold hover:text-primary font-bold hover:font-bold
              py-2 mt-4 px-5 shadow-md transition duration-300  ease-in-out transform hover:scale-105"
          >
            {t("home.button2")}
          </Link>
        </div>
        <ScrollTrigger
          ...
          className="md:w-4/12 w-1/2 md:ml-0 md:mr-32  m-5 my-20"
        >
          <div
            className={`relative diamond w-full pl-12 pt-14 lg:mt-0 lg:pt-0 lg:pl-0 flex justify-end lg:flex-none lg:pr-0
                        `}
          >
            <img
              src={Img1}
