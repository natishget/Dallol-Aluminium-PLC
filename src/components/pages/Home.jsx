    ...
    <div className="w-full font-sans">
      ...
      <div className="grid lg:grid-cols-4 text-gray-600 bg-gray-100 md:p-14 p-8 lg:gap-x-6">
        <div className="lg:my-auto mb-12">
          ...
          <Link to="service">
            <button className="hover:bg-black bg-primary text-gray-900 hover:text-primary font-bold hover:font-bold py-2 mt-4 px-4 shadow-lg rounded-xl transition duration-300 ease-in-out transform hover:scale-105">
              {t("home.button1")}
            </button>
          </Link>
        </div>
        ...
        <div className="rounded-xl bg-gray-200 lg:mb-0 mb-12">
          <img
            className="rounded-t-xl lg:w-84 lg:h-64"
            src="src/img/oneimg.png"
            alt=""
          />
          <div>
