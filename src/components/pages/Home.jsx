    ...
    <div className='w-full font-sans'>
      ...
      <div className='lg:p-16 p-10 lg:pt-44 pt-32 lg:grid grid-cols-2 w-full text-sans pb-14'>
        <div className='lg:pb-0 pb-14'>
          ...
          <p className='mt-4 text-gray-600 mb-10'>{t("home.paragraph")}</p>
          <Link to="about" className='hover:bg-black bg-primary text-gray-900 font-bold hover:text-primary font-bold hover:font-bold
           py-2 mt-4 px-5 shadow-md transition duration-300 ease-in-out transform hover:scale-105'>{t("home.button")}</Link>
        </div>
